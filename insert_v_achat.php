<?php
require "config.php";
require "../fonctions/gPostvalue.php";


// Requète est POST
if ($_SERVER["REQUEST_METHOD"] === "POST") {
// Appel a la fonction gPostValue.php
...
if (!testInsertAchatChampVide($vehicule)){

die("tous les champs doit ètre saisies");
   ...
   // redirection
        header("Location: admin_ajout_achat.php?success=1");
        exit;
